<div class="btn-group automobile-accessory">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[category]" class="col-sm-2 control-label">
                                        {!! trans('automobile::accessory.label.category')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[category]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[company]" class="col-sm-2 control-label">
                                        {!! trans('automobile::accessory.label.company')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[company]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
$(document).ready(function(){
    ...
    $(".automobile-accessory .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/automobile.accessory.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".automobile-accessory .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.automobile-accessory .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'automobile.accessory.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#automobile-accessory-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#automobile-accessory-list .btn-reset-filter').css('display', 'none');
