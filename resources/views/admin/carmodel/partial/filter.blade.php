<div class="btn-group automobile-carmodel">
...
$(document).ready(function(){
    ...
    $(".automobile-carmodel .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/automobile.carmodel.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".automobile-carmodel .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.automobile-carmodel .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'automobile.carmodel.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#automobile-carmodel-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#automobile-carmodel-list .btn-reset-filter').css('display', 'none');
