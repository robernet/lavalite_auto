<div class="btn-group automobile-directory">
...
$(document).ready(function(){
    ...
    $(".automobile-directory .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/automobile.directory.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".automobile-directory .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.automobile-directory .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'automobile.directory.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#automobile-directory-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#automobile-directory-list .btn-reset-filter').css('display', 'none');
