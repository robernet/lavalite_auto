<div class="btn-group automobile-make">
...
$(document).ready(function(){
    ...
    $(".automobile-make .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/automobile.make.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".automobile-make .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.automobile-make .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'automobile.make.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#automobile-make-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#automobile-make-list .btn-reset-filter').css('display', 'none');
