...
$links['form'] = guard_url('automobile/automobile') . '/' . $automobile->getRouteKey();
@endphp
...
@section('sub.title') 
{!! __('automobile::automobile.title.edit') !!}
@stop
...
@section('content') 
    @include('automobile::automobile.partial.entry', ['mode' => 'edit'])
@stop
