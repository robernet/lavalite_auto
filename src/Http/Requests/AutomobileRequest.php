...
namespace Laraauto\Automobile\Http\Requests;
...
class AutomobileRequest extends FormRequest
{
    ...
    {
        $this->model = $this->route('automobile');

        if (is_null($this->model)) {
            // Determine if the user is authorized to access automobile module,
    ...
    {
        return user()->canDo('automobile.automobile.view');
    }
}
